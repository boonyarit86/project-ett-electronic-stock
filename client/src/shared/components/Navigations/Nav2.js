...
import { Avatar, Menu, MenuItem, Badge, Typography, IconButton, Toolbar, AppBar, TextField, Card, CardContent } from "@material-ui/core";
...
export default function Nav2() {
    ...
    // กำหนดค่ารายการอุปกรณ์เป็นค่า global
    useEffect(() => {
    ...
    const renderMenu = (
        ...
        >
            ...
            <Link to={`/profile/edit`}><MenuItem onClick={handleMenuClose}>แก้ไขโปรไฟล์</MenuItem></Link>
            ...
            <AppBar position="static">
                <Toolbar>
                    ...
                    <Typography className={classes.title} variant="h6" noWrap>
                        <Link to="/tool/list" className={classes.webName}>Stock-Electronic</Link>
                    </Typography>
